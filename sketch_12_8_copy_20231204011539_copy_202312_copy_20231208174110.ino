...
void display_vals( struct pm_data *parsed )
{
	...
	sprintf( buff3,"%03hu", parsed->pm_10_0_env ) ;
  //snprintf( buff4, sizeof(buff4), "%03hu", (millis() - previousOnMillis)/60000.0 ) ;
  myLong = (millis() - previousOnMillis)/60000 ;
  snprintf(buff4, 100, "%03hu", myLong);
